...
function DeletePics(props) {
  return (
    <div className=''>
      <h1 className='text-2xl font-medium text-white pb-2 capitalize align-left pl-2'>Remove Extra Pics</h1>
      <div className='flex flex-wrap justify-evenly'>
        {props.pics.map(pic => (
          <div className='relative group m-2' key={pic}>
            <img src={`${pic}`} className='object-cover w-40 h-40 md:w-52 md:h-52' />
